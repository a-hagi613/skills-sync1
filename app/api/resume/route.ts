...
//   });
// // Update existing users with maxCoverLetters not equal to 3
...
//   if (user && user.maxResumes <= 0) {
//     return new Response('Maximum number of resumes reached', { status: 400 });
//   }
