...
// import { GrSync } from "@react-icons/all-files/gr/GrSync";
...
import SideNav from "@/components/SideNavM";
  ...
  const handleSync = async () => {
    ...
    const messages = [
      {
        role: "system",
        content:
        "You are coldMessageGPT, an AI assistant from Skill-Sync and the world's leading researcher on cold calling and personal messages. You will be given some information that may include a job description with requreiments and qualifications and a resume for background information on the candidate. Your job is to generate a personal message to the recruiter/hiring manager of that job with regards to a potential job offer. Make it clear and professional. If the information given to you is not related to the cover letter or job search, respond with 'I'm sorry, please only provide information related to your cover letter'. Make it personal and tailored to each specific individual.",
      },
      {
        role: "user",
        content: `Here is the job posting i am looking at: ${jobDescription} and here is my resume ${resume}. Now please generate the personal message for me.`,
      },
    ];
    ...
    try {
      const response = await axios.post(
        ...
        "https://skill-sync.vercel.app/api/message",
      ...
      try {
        await axios.post(
          //"http://127.0.0.1:3000/api/message-save",
          "https://skill-sync.vercel.app/api/message-save",
    ...
    <div className="flex flex-col w-full md:flex-row">
      ...
      <div className="flex-grow mx-4 my-12 overflow-x-hidden overflow-y-auto md:mx-12">
        ...
        <p className="mt-5 text-center mb-14">
          Generating your cold message is as easy as pasting your resume and
          some details about the job you are applying for then 🪄viola🪄 your
          generated message will appear like magic!{" "}
        </p>
        {isLoading ? (
          <div>
            <h1 className="my-3 text-xl font-bold text-center">
              Creating your new message...
            </h1>
            <Progress value={88} />
          </div>
        ) : (
                ...
                <div className="grid items-center gap-5 md:grid-cols-3">
                  <div className="md:col-span-1">
                    <h3 className="text-lg font-bold text-center">
                      Paste The Job Posting & Recruiter Contact Info
                    </h3>
                    <p className="my-2 text-xs italic text-center text-gray-400 font-extralight">
                      **share all relevant information such as recruiter &
